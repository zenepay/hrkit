...
class EmployeeFactory extends Factory
{
    ...
    public function definition(): array
    {
        return [
            ...
            'first_name_th' => $firstNameTh = $this->faker->regexify('[A-Za-z0-9]{50}'),
            'last_name_th' => $lastNameTh = $this->faker->regexify('[A-Za-z0-9]{50}'),
            'nick_name_th' => $nickNameTh = $this->faker->regexify('[A-Za-z0-9]{30}'),
            'full_name_th' => $firstNameTh . ' ' . $lastNameTh,
